...
//         table: 'posts',
//         callback: (payload) {
//            posts.removeWhere((element) => element.id == PostModel.fromJson(payload.oldRecord));
//         })
//     .subscribe();
...
//     .subscribe();
  ...
  void updateFeed(PostModel post)async{
    var user = await SupabaseService.client.from("users").select("*").eq("id", post.userId as Object).single(); 
    post.likes = [];
